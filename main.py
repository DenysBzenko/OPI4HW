from flask import Flask, jsonify  # Виправлено імпорт
import os
import logging
from logging.handlers import RotatingFileHandler  # Додано імпорт
...
# Визначення маршрутів безпосередньо
...
if __name__ == '__main__':
    # Run the app with environment-specific settings
